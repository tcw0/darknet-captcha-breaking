...
class Solver:
    def __init__(self, model_path="models/model1", encoding_path="model_labels.dat"):
        self.model_path = os.path.join(os.path.dirname(__file__), model_path)
        self.loaded_model = tf.keras.models.load_model(self.model_path)  # load trained model
...
def main():
    if len(sys.argv) != 2:
        raise ValueError("Please provide the path to the image-file as an argument!")
